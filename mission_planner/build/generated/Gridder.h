...
struct Pose
{
    ...
    float y;
    float theta;
    ::RoboCompGridder::VecFloats covariance;

    /**
     * Obtains a tuple containing all of the struct's data members.
     * @return The data members in a tuple.
     */
    std::tuple<const float&, const float&, const float&, const ::RoboCompGridder::VecFloats&> ice_tuple() const
    {
        return std::tie(x, y, theta, covariance);
    }
};
...
struct StreamReader<::RoboCompGridder::Pose, S>
{
    ...
    {
        istr->readAll(v.x, v.y, v.theta, v.covariance);
    }
};
...
typedef ::std::vector< ::Ice::Float> VecFloats;
